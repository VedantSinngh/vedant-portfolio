...
//                     <h1 className='text-7xl font-thin mb-6 tracking-wider bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-transparent'>
//                         About
//                         <span className='ml-4 text-neutral-500'>
//                             Me
//                         </span>
//                     </h1>
//                     <div className="w-40 h-1.5 bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 rounded-full shadow-lg shadow-purple-500/20" />
//                 </motion.div>

//                 {/* Laptop Frame */}
//                 <div className="flex justify-center items-center min-h-[70vh] perspective-1000">
//                     <motion.div 
...
//                     >
//                         {/* Laptop Top */}
//                         <div className="relative bg-neutral-800 rounded-t-2xl p-4 shadow-xl border border-neutral-700">
//                             {/* Screen Content */}
//                             <motion.div 
//                                 variants={item}
//                                 className="relative overflow-hidden rounded-lg bg-neutral-900 p-8"
//                             >
//                                 {/* Decorative Elements */}
...
//                                 <div className="mt-8 space-y-8 backdrop-blur-lg bg-neutral-900/50 rounded-xl p-8 shadow-2xl border border-neutral-800/50">
//                                     <p className="text-xl leading-relaxed text-gray-300 font-light">
//                                         <motion.span 
//                                             variants={item}
//                                             className="block mb-8"
//                                         >
//                                             <span className="text-4xl font-normal bg-gradient-to-r from-white via-gray-200 to-gray-300 bg-clip-text text-transparent">
...
//                                             <div className="backdrop-blur-md bg-neutral-800/30 p-6 rounded-xl border border-neutral-700/50">
//                                                 <span className="text-2xl font-semibold bg-gradient-to-r from-pink-300 to-purple-500 bg-clip-text text-transparent">
//                                                     93.2%
//                                                 </span>
//                                                 <p className="text-gray-400 mt-2">12th Grade at DAV</p>
//                                             </div>
//                                             <div className="backdrop-blur-md bg-neutral-800/30 p-6 rounded-xl border border-neutral-700/50">
//                                                 <span className="text-2xl font-semibold bg-gradient-to-r from-pink-300 to-purple-500 bg-clip-text text-transparent">
//                                                     9.00 CGPA
//                                                 </span>
//                                                 <p className="text-gray-400 mt-2">Current Grade at SRMIST</p>
//                                             </div>
//                                         </motion.div>
...
//                         {/* Laptop Bottom */}
//                         <div className="h-4 bg-neutral-800 rounded-b-lg mx-auto w-[95%] shadow-xl"></div>
